...
namespace VisualEffects.Controller.Editor
{
    [CustomPropertyDrawer(typeof(BaseController), true)]
    public class ControllerDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (EditorGUI.DropdownButton(typeRect, new GUIContent(displayName ?? "Select Controller Type"),
                    FocusType.Keyboard))
            {
                ...
                {
                    menu.AddDisabledItem(new GUIContent("No controllers found"));
                    menu.ShowAsContext();
                    return;
                }
        ...
        private static string GetShortTypeName(string fullTypeName)
        {
            ...
            return parts.Length > 1 ? parts[2].Split('.').Last() : fullTypeName;
        }
    }
}
